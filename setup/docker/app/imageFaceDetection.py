...
def frame_to_faceprint(frame): # frame is a mat
    haar_face_cascade = cv2.CascadeClassifier('/opencv/data/haarcascades/haarcascade_frontalface_default.xml') # initialize haar cascade
    ...
    face = faces[0]
    face_net = cv2.dnn.readNetFromCaffe('bvls_googlenet.prototxt', 'bvlc_googlenet.caffemodel') # load dnn
